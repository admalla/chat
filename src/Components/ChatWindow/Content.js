      ...
      return (
        <div id='msg'>
          ...
          <div className='time-read'>
            <span className='time-message'>{moment(item.time).format('HH:MM')}</span>
            <span className='read-icon'>
              <span className="material-icons hide-icon" onClick={handleOnClick}>
                keyboard_arrow_down
              </span>
              {item.read ? (
              <span className="material-icons done-icon">
                done_all
              </span>
            ) : (
              <span className="material-icons done-icon">
